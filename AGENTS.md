...
- After applying a new functionality, commit and push the change automatically, then rebuild or restart the running app so the online/local instance is not stale. If either step is blocked, report the exact blocker.
