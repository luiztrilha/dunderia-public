...
// atMentionPattern matches @slug patterns in messages without absorbing
// trailing punctuation such as commas or colons.
var atMentionPattern = regexp.MustCompile(`@([A-Za-z0-9][A-Za-z0-9_-]*)`)
