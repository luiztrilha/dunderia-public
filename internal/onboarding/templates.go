...
func DefaultTemplates() []TaskTemplate {
	return []TaskTemplate{
		{ID: "landing", Title: "Draft the landing page", Description: "Hero, value props, one clear CTA.", OwnerSlug: "executor"},
		{ID: "repo", Title: "Set up repo structure", Description: "Folders, README, CI scaffold. Keep it easy to navigate.", OwnerSlug: "executor"},
		{ID: "spec", Title: "Write the product spec", Description: "What we're building, why, and what done looks like.", OwnerSlug: "planner"},
