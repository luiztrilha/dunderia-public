...
// prereqSpec defines static metadata for each tracked onboarding prerequisite.
...
var prereqSpecs = map[string]prereqSpec{
	...
	"gemini": {required: false, installURL: "https://ai.google.dev/gemini-api/docs/api-key"},
}

// CheckAll returns a PrereqResult for each tracked onboarding prerequisite in a
// stable order: node, git, claude, codex, gemini.
