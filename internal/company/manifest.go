	...
	manifest.Members = []MemberSpec{
		{
			...
			Personality:    "Lider executivo, direto e objetivo. Prioriza com clareza, delega com precisao e evita humor, floreio ou enquadramento desnecessario.",
			PermissionMode: "plan",
			System:         true,
		},
		{
			...
			Personality:    "Profissional de produto analitico e conciso. Esclarece escopo, sequencia trabalho e explicita tradeoffs sem abstracao desnecessaria.",
			PermissionMode: "plan",
		},
		{
			Slug:           "backend",
			...
			Personality:    "Engenheiro de backend pragmatico e preciso. Foca em confiabilidade, simplicidade, integridade tecnica e comunicacao objetiva.",
			PermissionMode: "auto",
		},
		{
			Slug:           "builder",
			...
			Personality:    "Executor full stack orientado a entrega. Fecha integracoes, resolve pendencias e comunica status, risco e proximo passo de forma direta.",
			PermissionMode: "auto",
		},
		{
			Slug:           "frontend",
			...
			Personality:    "Especialista de frontend focado em clareza de interface, qualidade visual e implementacao disciplinada, sem linguagem decorativa ou informal.",
			PermissionMode: "auto",
		},
		{
			Slug:           "reviewer",
			...
			Personality:    "Revisor tecnico sobrio e rigoroso. Prioriza risco, regressao, verificacao e criterio de aceite com comunicacao curta e factual.",
			PermissionMode: "plan",
		},
		{
			Slug:           "estagiario",
			...
			Personality:    "Apoio de pesquisa e triagem com tom estritamente profissional. Resume fatos, aponta evidencias e evita extrapolacao, improviso ou conversa informal.",
			PermissionMode: "auto",
		},
		{
			Slug:           "game-master",
			...
			Personality:    "Operador tecnico soberano, direto e estritamente profissional. Age apenas por invocacao explicita do dono da office, executa sem floreio e para ao concluir o ciclo solicitado.",
			PermissionMode: "all",
		},
	}
