...
func materializeManifestFromBlueprintRefs(manifest Manifest, repoRoot string) (Manifest, bool) {
	...
	resolved := Manifest{
		Name:          firstNonTemplateNonEmpty(strings.TrimSpace(cfg.CompanyName), strings.TrimSpace(manifest.Name), strings.TrimSpace(operationBlueprint.Name), "The DunderIA Office"),
