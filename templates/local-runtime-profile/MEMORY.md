...
- Em `2026-04-19`, o OpenClaw foi descomissionado como runtime ativo do workspace; o estado preservado foi arquivado em `D:\Repos\_archive\openclaw-decom-2026-04-19`, e o runtime local ativo passou a ser `codex`. Em `2026-06-10`, os launchers MCP compartilhados e os wrappers de Local AI uteis foram extraidos do repo `dunderia` para a camada neutra do workspace em `D:\Repos\scripts\mcp\`, `D:\Repos\scripts\local-ai\` e `D:\Repos\config\codex\workspace-mcp-settings.json`.
