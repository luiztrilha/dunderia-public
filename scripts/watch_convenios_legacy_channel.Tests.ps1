...
$scriptPath = Join-Path $here 'watch_convenios_legacy_channel.ps1'

Describe 'watch_convenios_legacy_channel' {
  ...
  "messages": [
    {
      ...
      "from": "reviewer",
      "channel": "convenios-legacy",
      "content": "Bloqueio objetivo: o office precisa apontar para D:\\Repos\\ConveniosWebBNB_Antigo para revisar RecursoHumano.Cadastro.aspx.cs.",
...
'@ | Set-Content -LiteralPath $tasksPath -Encoding UTF8
        ...
        $result.repaired_workspace_path | Should Match 'ConveniosWebBNB_Antigo'
  ...
  "messages": [
    {
      ...
      "from": "reviewer",
      "channel": "convenios-legacy",
      "content": "Contexto antigo: usar D:\\Repos\\ConveniosWebBNB_Antigo.",
      "timestamp": "2026-04-19T20:10:15Z"
    },
    {
      "id": "msg-21",
      ...
      "channel": "convenios-legacy",
      "content": "Correção mais recente: antes estava D:\\Repos\\ConveniosWebBNB_Antigo, mas o root desta sessão é D:\\Repositórios\\ConveniosWebBNB_Antigo\\WSConvenio.",
  ...
  "tasks": [
    {
      ...
      "owner": "builder",
      "execution_mode": "external_workspace",
      "workspace_path": "D:\\Repos\\ConveniosWebBNB_Antigo"
    }
  ]
}
'@ | Set-Content -LiteralPath $tasksPath -Encoding UTF8
        ...
        $result.repaired_workspace_path | Should Be 'D:\Repositórios\ConveniosWebBNB_Antigo\WSConvenio'
    }
...
'@ | Set-Content -LiteralPath $tasksPath -Encoding UTF8
        ...
        $result.ok | Should Be $true
        Test-Path -LiteralPath $snapshotPath | Should Be $true
        $snapshot.channel | Should Be 'convenios-legacy'
