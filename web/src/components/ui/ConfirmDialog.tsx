  ...
  return (
    ...
    >
      <div className="confirm-card card">
        <h3 className="confirm-title">{opts.title || t('common.confirm.areYouSure')}</h3>
        ...
        <div className="confirm-actions">
          <button
            ...
            disabled={running}
          >
            {opts.cancelLabel || t('common.confirm.cancel')}
          </button>
          <button
            type="button"
            ...
            autoFocus
          >
            {running ? t('common.confirm.working') : opts.confirmLabel || t('common.confirm.confirm')}
          </button>
        </div>
      </div>
    </div>
