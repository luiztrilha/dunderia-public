...
func TestResolveOutDir(t *testing.T) {
	got := resolveOutDir("/tmp/content-review-bundle")
	want := "/tmp/content-review-handoff"
	if got != want {
...
func TestBuildApprovalGateBlocksContradictoryArtifacts(t *testing.T) {
  ...
  "source_bundle": `+jsonStringLiteral(t, dir)+`,
  "live_packet_path": "docs/launch-ops/generated/live-client-pilot/content-packet-inbox-operator.json",
...
`)
  ...
  "tags": ["ai automation"],
  "notes": ["Live packet path: docs/launch-ops/generated/live-client-pilot/content-packet-inbox-operator.json"]
}
`)
  ...
  "properties": {
    ...
    "Live Packet": "docs/launch-ops/generated/live-client-pilot/content-packet-inbox-operator.json"
  },
  "checklist": [
...
func jsonStringLiteral(t *testing.T, value string) string {
	...
	if err != nil {
		t.Fatalf("marshal JSON string literal for %q: %v", value, err)
	}
	return string(data)
}
